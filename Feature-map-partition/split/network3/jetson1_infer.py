...
def jetson1_inference(rank ):
    ...
    model_part3_rref = rpc.remote(f"raspberrypi7", create_model_part3_instance)
    ...
    with torch.no_grad():
        # for images, labels in train_loader:
            ...
            intermediate_output3 = rpc.rpc_sync(f"raspberrypi7", training7,
                                                args=(model_part3_rref, intermediate_output2, 4))
            output = rpc.rpc_sync(f"raspberrypi8", fc_training,args=(model_part4_rref, intermediate_output3, 4,))
